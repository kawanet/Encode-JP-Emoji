...
ok( "a" =~ /\P{InEmojiKddiwebUnicode}/,  "ASCII InEmojiKddiwebUnicode" );
...
ok( "\x{6F22}" =~ /\P{InEmojiKddiwebUnicode}/,  "Kanji InEmojiKddiwebUnicode" );
...
ok( "\x{EC40}"  =~ /\p{InEmojiKddiwebUnicode}/,  "Sun InEmojiKddiwebUnicode" );
